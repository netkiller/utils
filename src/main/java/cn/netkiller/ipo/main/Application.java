...
//		process.add(new IncludeProcess("\"logType\":\"3\""));
//		process.add(new IncludeProcess("\"businessPlatform\":\"3\""));
...
//		map.put("browser", "http_user_agent"); // user-agent
		...
		/*
		 * 
		 * "@timestampGMT8":"2017-10-01T00:00:05+08:00", "@reqstatus":"200",
		 * "@clientip":"117.136.88.94", "@url":"/1.gif", "@serverip":"192.168.8.177",
		 * "@body_bytes_sent":35, "@bytes_sent":266, "@referer": "-", "@params":
		 * "logType=3 &deviceId=44:c3:46:11:49:38 &deviceType=Android &platformType=GTS2
		 * &accountType= &model=MHA-AL00 &userIp=null &deviceResolution=360*604
		 * &platformVersion=1.5.1 &carrier=HUAWEI &eventAction=ClickTabbar
		 * &eventCategory=Main &eventLabel=broadcast &eventValue=broadcast &userType=3
		 * &account=86133808 &netStatus=mobile &channel=fx0 &businessPlatform=1
		 * &platformName=%E9%87%91%E9%81%93%E5%A4%96%E6%B1%87%E6%8A%95%E8%B5%84com.gwtsz
		 * .gts2 &idfa=864678032385641 &dates=1506787203858 &", "@browser":
		 * "okhttp/3.2.0"}
		 */
